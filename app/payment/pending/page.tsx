...
export default function PendingPage() {
  ...
  return (
    <div style={page}>
      {/* Animated clock */}
      <div style={{ width: 80, height: 80, borderRadius: "50%", background: "#dde1ff", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20, animation: "pulse 2s ease-in-out infinite" }}>
        <span className="material-symbols-outlined" style={{ fontSize: 44, color: "#0d2067", fontVariationSettings: "'FILL' 1" }}>schedule</span>
      </div>

      <h2 style={heading}>Waiting for Admin Approval</h2>
      <p style={body}>
        Thank you for your payment! Our admin team will verify your QR payment and approve your account.
      </p>

      {/* Status card */}
      <div style={{ background: "#fff", border: "1px solid #c6c5d2", borderRadius: 14, padding: 18, width: "100%", maxWidth: 340, marginTop: 24, marginBottom: 24 }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <StatusRow icon="check_circle" color="#346b00" label="QR Payment Submitted" done />
      ...
      <div style={{ background: "#fffbeb", border: "1px solid #fde68a", borderRadius: 12, padding: 14, maxWidth: 340, width: "100%", marginBottom: 16 }}>
        <p style={{ fontSize: 13, color: "#92400e", lineHeight: 1.6 }}>
          <strong>What happens next:</strong> An admin will check your payment (usually within a few hours). This page updates automatically — no need to refresh.
        </p>
      </div>

      {/* WhatsApp contact card */}
      <div style={{ background: "#f0fdf4", border: "1.5px solid #86efac", borderRadius: 14, padding: 16, maxWidth: 340, width: "100%", marginBottom: 20 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
          ...
          <div>
            <p style={{ fontFamily: "'Manrope', system-ui, sans-serif", fontSize: 14, fontWeight: 700, color: "#166534" }}>Need faster approval?</p>
            <p style={{ fontSize: 12, color: "#166534" }}>Contact admin on WhatsApp</p>
          </div>
        </div>

        <p style={{ fontSize: 13, color: "#166534", lineHeight: 1.6, marginBottom: 12 }}>
          📸 <strong>Send a screenshot</strong> of your transaction to the WhatsApp number below for faster processing.
        </p>
